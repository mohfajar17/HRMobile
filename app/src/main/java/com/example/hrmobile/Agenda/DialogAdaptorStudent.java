...
class DialogAdaptorStudent extends BaseAdapter {
    ...
    private ArrayList<com.example.hrmobile.Agenda.Dialogpojo> alCustom;


    public DialogAdaptorStudent(Activity context, ArrayList<com.example.hrmobile.Agenda.Dialogpojo> alCustom) {
